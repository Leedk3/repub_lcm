...
#ifndef __eurecar_rmc_ros_t_hpp__
#define __eurecar_rmc_ros_t_hpp__
...
class rmc_ros_t
{
    public:
        ...
        /// Track angle in degrees True cw
        double     lat;
...
int rmc_ros_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int rmc_ros_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int rmc_ros_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t rmc_ros_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* rmc_ros_t::getTypeName()
{
    return "rmc_ros_t";
}

int rmc_ros_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int rmc_ros_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int rmc_ros_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t rmc_ros_t::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x22452ab9ee8a6ddbLL;
